...
- Added a first-install, 28-frame tutorial using three fictional sites, production pulse/chip/log renderers, resumable local progress, and a handoff to the existing permission setup.
